            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group{{ $errors->has('idMovimiento') ? ' has-error' : '' }}">
                        <label for="idMovimiento" class="col-md-4 control-label">idMovimiento</label>
                     ...
                     <div class="form-group{{ $errors->has('idFicha') ? ' has-error' : '' }}">
                       ...
                       <!-- informacion de la ficha -->
                        ...
                        <label for="idMovimiento" class="col-md-4 control-label">idHabitacion</label>
                    ...
                    <div class="form-group{{ $errors->has('Habitacion_Numero') ? ' has-error' : '' }}">
                        <label for="Habitacion_Numero" class="col-md-4 control-label">Habitacion_Numero</label>
                        ...
                        <div class="form-group{{ $errors->has('Movimiento_Descripcion') ? ' has-error' : '' }}">
                            <label for="Movimiento_Descripcion" class="col-md-4 control-label">Descripcion</label>
